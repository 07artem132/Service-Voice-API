...
use Api\Http\Requests\TeamSpeakVirtualServerChannelMoveRequest;
use Api\Http\Requests\TeamSpeakVirtualServerChannelEditRequest;
use Api\Http\Requests\TeamSpeakVirtualServerChannelCreateRequest;
...
class TeamSpeakVirtualServerChannelController extends Controller {
	...
	function List( int $instance_id, string $bashe64uid ): JsonResponse {
		...
		$this->ts3conn = new TeamSpeak( $this->instance_id, $this->uid );
		$data          = $this->ts3conn->VirtualServerChannelList();
	 ...
	 */
	/**
	 * @param TeamSpeakVirtualServerChannelCreateRequest $request
	 * @param int $instance_id
	 * @param string $bashe64uid
	 *
	 * @return JsonResponse
	 */
	function Create( TeamSpeakVirtualServerChannelCreateRequest $request, int $instance_id, string $bashe64uid ): JsonResponse {
		$this->instance_id = $instance_id;
		$this->uid         = base64_decode( $bashe64uid );

		$this->ts3conn = new TeamSpeak( $this->instance_id, $this->uid );
		$data['cid']   = $this->ts3conn->VirtualServerChannelCreate( $request->all() );
	...
	function Delete( int $instance_id, string $bashe64uid, int $channelid ): JsonResponse {
		...
		$this->ts3conn = new TeamSpeak( $this->instance_id, $this->uid );
		$data          = $this->ts3conn->VirtualServerChannelDelete( $this->cid );
	...
	function Info( int $instance_id, string $bashe64uid, int $channelid ): JsonResponse {
		...
		$this->ts3conn = new TeamSpeak( $this->instance_id, $this->uid );
		$data          = $this->ts3conn->VirtualServerChannelInfo( $this->cid );
	 ...
	 */
	/**
	 * @param TeamSpeakVirtualServerChannelMoveRequest $request
	 * @param int $instance_id
	 * @param string $bashe64uid
	 * @param $channelid
	 *
	 * @return JsonResponse
	 */
	function Move( TeamSpeakVirtualServerChannelMoveRequest $request, int $instance_id, string $bashe64uid, int $channelid ): JsonResponse {
		$this->instance_id = $instance_id;
		$this->uid         = base64_decode( $bashe64uid );
		$this->cid         = $channelid;

		$this->ts3conn = new TeamSpeak( $this->instance_id, $this->uid );
		$this->ts3conn->VirtualServerChannelMove( $this->cid, $request->all() );
	 ...
	 */
	/**
	 * @param TeamSpeakVirtualServerChannelEditRequest $request
	 * @param int $instance_id
	 * @param string $bashe64uid
	 * @param int $channelid
	 *
	 * @return JsonResponse
	 */
	function Edit( TeamSpeakVirtualServerChannelEditRequest $request, int $instance_id, string $bashe64uid, int $channelid ): JsonResponse {
		$this->instance_id = $instance_id;
		$this->uid         = base64_decode( $bashe64uid );
		$this->cid         = $channelid;
		$this->ts3conn     = new TeamSpeak( $this->instance_id, $this->uid );
		$this->ts3conn->VirtualServerChannelEdit( $this->cid, $request->all() );
